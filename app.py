...
def main():
    ...
    if uploaded_file is None:
        ...
        st.image("/Users/thebitanpaul/Library/CloudStorage/GoogleDrive-thebitanpaul@gmail.com/My Drive/Creations/Python Projects/DataAnalyzer/waiting.jpg", use_column_width=True)
        return
